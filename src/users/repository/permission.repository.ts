...
export class PermissionRepositoryWrapper {
  ...
  public async createPermission(
    ...
    permission.department = await this.departmentRepositoryWrapper.findOneById(departmentId);
  ...
  public async findOne(name: string, departmentId: number): Promise<Permission | null> {
    const department = await this.departmentRepositoryWrapper.findOneById(departmentId);
